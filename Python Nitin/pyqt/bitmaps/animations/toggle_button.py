...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self, parent = None, bar_color = Qt.GlobalColor.gray,
                 checked_color = "#00B0FF", handle_color = Qt.GlobalColor.white,
        ...
        self._handle_checked_color = QBrush(QColor(checked_color))
    ...
    def setup_animation(self, value):
        ...
        if value: self.animation.setEndValue(1)
        else: self.animation.setEndValue(0)
    ...
    def paintEvent(self, e: QPaintEvent):
        ...
        if self.isChecked():
            ...
            p.setBrush(self._handle_checked_color)
    ...
    @pyqtProperty(float)
    def pulse_radius(self): return self._pulse_radius
